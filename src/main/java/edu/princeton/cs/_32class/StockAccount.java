package edu.princeton.cs._32class;

import edu.princeton.cs._31datatype.StockQuote;
...
public class StockAccount {
    ...
    private final double cash;     // cash balance
    private final int n;           // number of stocks in portfolio
    private final int[] shares;    // shares[i] = number of shares of stock i
    private final String[] stocks; // stocks[i] = symbol of stock i
